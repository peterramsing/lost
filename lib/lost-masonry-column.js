...
module.exports = function lostMasonryColumnDecl(css, settings) {
  css.walkDecls(
    ...
    function lostMasonryColumnFunction(decl) {
      ...
      decl.parent.nodes.forEach(
        function lostMasonryColumnRounderFunction(declaration) {
      ...
      decl.parent.nodes.forEach(
        function lostMasonryColumnGutterFunction(declaration) {
      ...
      decl.parent.nodes.forEach(
        function lostMasonryColumnFlexboxFunction(declaration) {
