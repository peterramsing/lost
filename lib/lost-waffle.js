  ...
  css.walkDecls('lost-waffle', function lostWaffleDeclFunction(decl) {
    ...
    decl.parent.nodes.forEach(declaration => {
      if (declaration.prop === 'lost-unit') {
        if (lostLogic.validateUnit(declaration.value, validUnits)) {
    ...
    cloneAllBefore({
      width: lostLogic.calcValue(
        lostWaffle,
        lostWaffleGutter,
        lostWaffleRounder,
        unit
      ),
      'max-width': lostLogic.calcValue(
        lostWaffle,
        lostWaffleGutter,
        lostWaffleRounder,
        unit
      ),
      height: lostLogic.calcValue(
        lostWaffle,
        lostWaffleGutter,
        lostWaffleRounder,
        unit
